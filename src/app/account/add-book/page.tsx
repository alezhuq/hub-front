          ...
          >
            <FormControl fullWidth>
              ...
              <Select
                ...
                fullWidth
              >
                <MenuItem value={"1"}>Фентезі</MenuItem>
                <MenuItem value={"2"}>Детектив</MenuItem>
                <MenuItem value={"3"}>Драма</MenuItem>
                <MenuItem value={"4"}>Історичний роман</MenuItem>
                <MenuItem value={"5"}>Класика</MenuItem>
                <MenuItem value={"6"}>Фантастика</MenuItem>
                <MenuItem value={"7"}>Поезія</MenuItem>
                <MenuItem value={"8"}>Пригоди</MenuItem>
                <MenuItem value={"9"}>Роман</MenuItem>
                <MenuItem value={"10"}>Трилер</MenuItem>
              </Select>
            </FormControl>
          </motion.div>
